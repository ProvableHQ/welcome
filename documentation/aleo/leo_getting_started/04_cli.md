...
Under the hood, the Leo [CLI](../../aleo/cli/run/run.md) will check for existing `.sum`, `.lpk`, `.lvk`, or `.proof` files 
in the build directory before running each command. This ensures that we don't run unnecessary commands.

## The Leo Language
To learn more about how to use the Leo Language, start [here](../../aleo/language/layout.md)

## The Leo CLI
To learn more about how to use the Leo CLI, start [here](../../aleo/cli/develop/new.md)